/*
  # Vroomly Core Schema - Phase 1

  ## Summary
  Creates the foundational database schema for Vroomly, an automotive services marketplace.

  ## New Tables
  1. `profiles` - One row per auth user; stores role (consumer/provider/admin), name, phone
  2. `providers` - Business listing for provider users; includes approval state and visibility flags
  3. `service_categories` - Master list of automotive service types (seeded)
  4. `provider_services` - Join table linking providers to service categories
  5. `vehicles` - Consumer garage vehicles
  6. `service_records` - Service history attached to vehicles
  7. `lead_requests` - Consumer inquiries sent to providers
  8. `provider_subscriptions` - Billing plan state per provider
  9. `provider_lead_events` - Event ledger for lead billing logic
  10. `reviews` - Consumer reviews for providers

  ## Security
  - RLS enabled on every table
  - Policies enforce ownership, role-based access, and public visibility rules
  - No table is left exposed without explicit policies

  ## Notes
  - All primary keys are UUIDs
  - updated_at triggers applied to mutable tables
...
-- ============================================================
-- TABLE: providers
-- Business listing for provider-role users
-- ============================================================
...
-- Master list — managed by admins, readable by all
-- ============================================================
...
-- Join table: providers <-> service_categories
-- ============================================================
...
-- Service history attached to vehicles
-- ============================================================
...
-- ============================================================
-- TABLE: lead_requests
-- Consumer inquiries sent to a provider
-- ============================================================
...
-- Billing plan state per provider (Stripe-ready)
-- ============================================================
...
-- ============================================================
-- TABLE: provider_lead_events
-- Billing/event ledger for lead charging logic
-- ============================================================
...
-- ============================================================
-- TABLE: reviews
-- Consumer reviews for providers (future trust layer)
-- ============================================================
...
-- Composite index for public provider search
